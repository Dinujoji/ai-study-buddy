    ...
    <div className="flex min-h-screen bg-background">
      ...
      >
        <div className="flex items-center gap-3 px-6 py-5 border-b border-sidebar-border">
          ...
          <span className="text-lg font-bold text-sidebar-accent-foreground">LearnAI</span>
        ...
        <div className="absolute bottom-4 left-3 right-3 space-y-3">
          ...
          <button
            onClick={toggleDark}
            className="flex items-center gap-3 w-full px-4 py-2.5 rounded-lg text-sm font-medium text-sidebar-foreground hover:bg-sidebar-accent transition-colors"
          >
          ...
          <button
            onClick={signOut}
            className="flex items-center gap-3 w-full px-4 py-2.5 rounded-lg text-sm font-medium text-sidebar-foreground hover:bg-destructive/20 hover:text-destructive transition-colors"
          >
